        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Expense Category Details</h3> </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" class="form-control"  name="expense_name" pattern= "[a-zA-Z][a-zA-Z ]+" placeholder="Enter a Expense Name.."required>
                                                    </div>
                                            </div>
